...
class x3d_avg_xzt(xp.x3d_avg_xzt, temp_tbl_base):
    ...
    def _get_uplus_yplus_transforms(self, PhyTime):
        ...
        def x_transform(y): return y/delta_v
        def y_transform(u): return (u[0]-u)/u_tau
    ...
    def conv_distance_calc(self, t0=None):
        ...
        start_distance = integrate_simps(
            U_w[:start_index], times[:start_index])
...
class x3d_k_budget_xzt(xp.x3d_k_budget_xzt, temp_tbl_base):
    pass
